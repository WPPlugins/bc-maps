...
function bc_maps_show_map(){
	echo apply_filters('bc_maps_show_map_div', '<div id="bc-maps-map" style="width:100%; height:400px;"></div>');
...
add_action('bc_maps_before_dynamic_js', 'bc_maps_save_auto_ip_base_location');
